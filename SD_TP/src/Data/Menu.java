...
public class Menu {
    ...
    private static void Ver_Leiloes(Armazenamento az) {
        ...
        for (int i=0; i<az.items_pra_venda.size(); i++){
                Venda it= az.items_pra_venda.get(i);
    ...
    private static void Vender_Item(Armazenamento az) {
        ...
        Venda item= new Venda(nome,descricao,Cliente_a_usar_o_sistema,0);
    ...
    private static void Terminar_Leilao(Armazenamento az) {
         ...
         for (int i=0;i<size;i++){
             Venda aux = az.items_pra_venda.get(i);
    ...
    Venda it1 = new Venda("TV","perfeitas condições","Joao",0);
    Venda it2 = new Venda("PC","bla bla","pedro",0);
